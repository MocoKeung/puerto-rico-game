...
exports.PLAYER_COLORS = exports.ALL_ROLES = exports.SHIPPING_VP = exports.TRADING_PRICES = exports.SHIP_CAPACITIES = exports.ROLE_BONUSES = exports.BUILDING_COSTS = exports.STARTING_RESOURCES = exports.INITIAL_RESOURCES = void 0;
exports.getInitialPlantationMarket = getInitialPlantationMarket;
exports.getInitialBuildings = getInitialBuildings;
exports.getInitialRoleState = getInitialRoleState;
...
function getInitialPlantationMarket() {
...
function getInitialRoleState(playerCount) {
    const roles = ['settler', 'mayor', 'builder', 'craftsman', 'captain', 'prospector'];
    return {
        available: roles,
        taken: [],
        currentRole: null,
...
function shouldGameEnd(state, playerCount) {
    if (state.colonistsInSupply === 0)
        return true;
    if (state.victoryPointSupply === 0)
        return true;
    return false;
}
...
// Colors for players
exports.PLAYER_COLORS = ['#e74c3c', '#3498db', '#2ecc71', '#f39c12', '#9b59b6'];
